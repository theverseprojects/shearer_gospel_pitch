    ...
    \{\
      ...
      content: (\
        <div className="text-center space-y-6">\
          ...
          <div className="text-sm text-gray-500 mt-4">Original Script by Oyakhire Russel \'95 2025</div>\
        </div>\
      )\
    \},\
    \
      ...
      content: (\
        <div className="space-y-4">\
          <p className="text-xl leading-relaxed">\
            ...
            When Jesus actually shows up, Ebun is pulled through time and space\'97from war-torn Syria \
          ...
          <p className="text-lg text-gray-700 leading-relaxed">\
            ...
            that's been holding him captive. This isn't the Jesus of stained glass windows\'97this is \
      ...
      content: (\
        <div className="grid grid-cols-2 gap-6">\
          <div className="bg-blue-50 p-6 rounded-lg">\
            ...
            <p className="text-sm">Faith content that doesn't preach\'97it experiences. Young, diverse, raw.</p>\
          </div>\
      ...
      content: (\
        <div className="space-y-4">\
          <div className="bg-gradient-to-r from-amber-500 to-orange-500 text-white p-6 rounded-lg mb-6">\
            ...
            <div className="text-sm">You're not just funding a film\'97you're joining a creative movement</div>\
          </div>\
\
...
\
          <div className="mt-8 bg-gradient-to-r from-gray-800 to-gray-900 text-white p-6 rounded-lg">\
            ...
            <ul className="text-sm space-y-1">\
              <li>\'95 Major film festivals (Sundance, Tribeca, SXSW)</li>\
              <li>\'95 Faith-based platforms (Angel Studios, Pure Flix)</li>\
              <li>\'95 Streaming services (short-form content arms)</li>\
              <li>\'95 Church screenings and community events</li>\
              <li>\'95 YouTube Premium and social media rollout</li>\
            </ul>\
          </div>\
        </div>\
      )\
